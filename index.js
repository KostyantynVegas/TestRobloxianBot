...
bot.on('message', message => {
     if (message.content ==="#help") {
         message.reply("Commands:!credits !noob, !lol, !shytka, !myavatar, !meme.");
     }
});
//credits command.
bot.on('message', message => {
